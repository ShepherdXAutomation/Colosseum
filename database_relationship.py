...
class DatabaseViewer:
    ...
    def create_widgets(self):
        ...
        self.player_characters_tree = ttk.Treeview(self.player_characters_tab, columns=('Player ID', 'Player Username', 'Character ID', 'Character Name'), show='headings')
    ...
    def populate_player_characters_table(self):
        self.c.execute('''SELECT pc.player_id, p.username, pc.character_id, c.name 
